...
function is_username_valid($name)
{
	...
	if($uppercase || !$lowercase || $number || strlen($name)<5 || strlen($name)>25 || $spesial)
	{
...
function is_password_valid($user)
{
 ...
 echo is_username_valid("febria");
 echo is_username_valid("Febria");
 echo is_password_valid("29&PASS");
